<header class="entry-header">
	...
	$sticky = is_sticky() ? '<span class="sticky-label"><i class="fa fa-thumb-tack"></i><span class="screen-reader-text">' . penci_tran_featured_text( 'penci_tran_featured_text' ) . '</span></span>  ' : '';
